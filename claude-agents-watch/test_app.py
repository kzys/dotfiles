...
def test_sort_key_puts_sessions_wanting_the_user_first():
    blocked = {"pid": None, "state": "blocked", "startedAt": 100}
    waiting = {"pid": 4, "status": "waiting", "startedAt": 200}
    live_idle_new = {"pid": 2, "status": "idle", "startedAt": 300}
    live_idle_old = {"pid": 3, "status": "idle", "startedAt": 200}
    live_busy = {"pid": 1, "status": "busy", "startedAt": 400}
    working = {"pid": None, "state": "working", "startedAt": 100}
    done = {"pid": None, "state": "done", "startedAt": 900}
    failed = {"pid": None, "state": "failed", "startedAt": 800}
